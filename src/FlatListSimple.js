...
import {FlatList, TouchableOpacity, Alert, StyleSheet, Text, View, Button} from 'react-native';
        ...
        return (
            <View style={styles.container}>
                <FlatList
                    ...
                    renderItem={({item}) =><Button title={item.key} onPress={()=>navigate('Details')}></Button>}
